...
def _safe_torch_load(file, map_location=None, weights_only=None):
    ...
    Args:
        ...
        weights_only: Whether to load only weights. If None, auto-detect based on PyTorch version
    ...
    if weights_only is None:
        ...
        return torch.load(file, map_location=map_location, weights_only=weights_only)
...
def load_from_pavi(filename, map_location=None):
    ...
    with TemporaryDirectory() as tmp_dir:
        ...
        checkpoint = _safe_torch_load(downloaded_file, map_location=map_location)
    return checkpoint
